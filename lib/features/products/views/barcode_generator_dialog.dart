                            ...
                            SizedBox(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  // Horizontal black divider in Left Area
                                  Container(
                                    height: 2.0,
                                    color: Colors.black,
                                  ),

                                  // Bottom: Price Box (Solid Black Container)
                                  Expanded(
                                    flex: 129,
                                    child: Container(
                                      color: Colors.black,
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  // Horizontal black divider in Right Area
                                  Container(
                                    height: 2.0,
                                    color: Colors.black,
                                  ),
                                  ...
                                  Expanded(
                                    flex: 109,
                                    child: Container(
                                      padding: const EdgeInsets.only(left: 6, right: 6, top: 12, bottom: 2),
